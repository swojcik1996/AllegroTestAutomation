...
public class ElectronicSubPage extends BasePage {
    ...
    public ElectronicSubPage randomSubcategory(){
        for (int i =0; i < electronic.size(); i++){
            System.out.println(electronic.get(i).getText());
        }
        return this;
    }
